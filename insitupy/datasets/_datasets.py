...
def human_breast_cancer(
    ...
    expected_he_md5sum = 'faf792e9555824c03af067b62d2a055b'
    ...
    # download image data
    if md5sum_image_check(image_dir/"slide_id__hbreastcancer__HE__histo.tif", expected_he_md5sum, overwrite):
